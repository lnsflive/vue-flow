...
<template>
  ...
  >
    <path
      fill="currentColor"
      d="m12 17l4-4l-1.4-1.4l-1.6 1.55V9h-2v4.15L9.4 11.6L8 13zm-6 5q-.825 0-1.412-.587T4 20V8l6-6h8q.825 0 1.413.588T20 4v16q0 .825-.587 1.413T18 22zm0-2h12V4h-7.15L6 8.85z"
    />
  </svg>
  ...
  >
    <path
      fill="currentColor"
      d="M12 20a8 8 0 0 1-8-8v-4l-3 3l-1-1l5-5l5 5l-1 1l-3-3v4a6 6 0 1 0 6-6v-2a8 8 0 0 1 0 16z"
    />
  </svg>

  <svg
    v-else-if="name === 'update'"
    class="icon"
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
  >
